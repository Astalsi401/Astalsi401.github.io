      ...
      <section className="my-4">
        ...
        <ol>
          ...
          <li>
            ...
            <ZoomImage className="col-sm-8 mx-auto" src={`${domain}/assets/images/cmder-git-clean1.png`} />
          </li>
          <li>
            列出最大的文件名稱
            <CodeChunk code="git rev-list --objects --all | grep 4f1a0424c890e4d3fa9b33dfe0d021ac119eb2be" />
            <ZoomImage className="col-sm-8 mx-auto" src={`${domain}/assets/images/cmder-git-clean2.png`} />
          </li>
          <li>
            刪除文件
