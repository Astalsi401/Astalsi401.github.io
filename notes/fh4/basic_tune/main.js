      ...
      <div>
        ...
        <section className="my-4">
          ...
          <ol type="i">
            ...
            <img id="camber" className="d-block my-2 mx-auto image-normal" src="https://astalsi401.github.io/assets/images/camber.png" alt="" />
            <h4>
              <li>束角：</li>
            </h4>
            <p>影響轉向能力，束角越大，轉向角度越大，直線時越不穩定。下圖為前+後-。拉力賽容許更大的前束角。調整束角時建議以0.1為單位慢慢調整。</p>
            <img id="toe" className="d-block my-2 mx-auto image-normal" src="https://astalsi401.github.io/assets/images/toe.png" alt="" />
            <h4>
              <li>前後傾角（4°~6°）：</li>
            </h4>
            <p>越高，直線時外傾角越穩定，但過彎時將增加負外傾角。在某些情況下，調到太高有可能使車輛重心過度自行回正，導致難以預測的移動。</p>
            <img id="caster" className="d-block my-2 mx-auto image-normal" src="https://astalsi401.github.io/assets/images/caster.png" alt="" />
          </ol>
        </section>
        <section className="my-4">
          <h3 className="mt-3">輪胎定位（甩尾）</h3>
          <ol type="i">
            <li>前外傾角：-5°</li>
            <li>後外傾角：0°</li>
            <li>前束角：5°</li>
        ...
        <section className="my-4">
          ...
          <ol>
            ...
            <img id="powerBand" className="d-block my-2 mx-auto image-normal" src="https://astalsi401.github.io/assets/images/powerBand.png" alt="" />
            <li>
          ...
          <ol type="i">
            ...
            <img id="driftGear" className="d-block my-2 mx-auto image-normal" src="https://astalsi401.github.io/assets/images/driftGear.png" alt="" />
            <li>
              <p>
        ...
        <section className="my-4">
          <h3 className="my-3 text-center" id="calculator">
            計算器
          </h3>
