    ...
    this.section = [
      {
        ...
        content: (
          <div>
            ...
            <CodeChunk code={`. clear\n. input str9 name iq /*str9: 空出9個字元的長度*/\n\n     name     iq\n 1. "Gene"    125\n 2. "Steve"    92\n 3. "Bob"      72\n 4. "Michael" 126\n 5. "Joan"    120\n 6. "Jim"      99\n 7. "Jane"    130\n 8. "Mary"    100\n 9. "Kevin"   120\n10. end`} language="output"></CodeChunk>
            <p>檢視資料信息</p>
            <CodeChunk code={`su iq, d\n/*su:summarize的縮寫，大致呈現一份資料的分配狀況，d代表detail，可以看到更詳細的信息。*/`} language="stata"></CodeChunk>
            <CodeChunk code={`. su iq, d\n/*su:summarize的縮寫，大致呈現一份資料的分配狀況，d代表detail，可以看到更詳細的信息。*/\n                             iq\n-------------------------------------------------------------\n      Percentiles      Smallest\n 1%           72             72\n 5%           72             92\n10%           72             99       Obs                   9\n25%           99            100       Sum of Wgt.           9\n\n50%          120                      Mean           109.3333\n                        Largest       Std. Dev.      19.57677\n75%          125            120\n90%          130            125       Variance         383.25\n95%          130            126       Skewness      -.6967588\n99%          130            130       Kurtosis       2.295479`} language="output"></CodeChunk>
            <p>另一種檢視資料的指令</p>
            <CodeChunk code={`univar iq`} language="stata"></CodeChunk>
