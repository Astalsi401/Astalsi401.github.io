        ...
        content: (
          <div>
            ...
            <div className="my-2">
              ...
              <CodeChunk code={`. clear\n\n. input g reward\n\n             g     reward\n  1. 1 20\n  2. 1 15\n  3. 1 17\n  4. 1 13\n  5. 1 18\n  6. 1 16\n  7. 2 14\n  8. 2 8\n  9. 2 11\n 10. 2 10\n 11. 2 6\n 12. 2 9\n 13. 3 12\n 14. 3 11\n 15. 3 9\n 16. 3 5\n 17. 3 6\n 18. 3 7\n 19. end`} language="output"></CodeChunk>
              <p>Stata算出H=11.038</p>
              <CodeChunk code={`kwallis reward, by(g)`} language="stata"></CodeChunk>
              <CodeChunk code={`. kwallis reward, by(g)\n\nKruskal-Wallis equality-of-populations rank test\n\n  +--------------------+\n  | g | Obs | Rank Sum |\n  |---+-----+----------|\n  | 1 |   6 |    92.00 |\n  | 2 |   6 |    44.50 |\n  | 3 |   6 |    34.50 |\n  +--------------------+\n\nchi-squared =    11.038 with 2 d.f.\nprobability =     0.0040\n\nchi-squared with ties =    11.072 with 2 d.f.\nprobability =     0.0039`} language="output"></CodeChunk>
              <p>df=2 以組數來計算df</p>
              <CodeChunk code={`di invchi2tail(2, .05)`} language="stata"></CodeChunk>
              <CodeChunk code={`. di invchi2tail(2, .05)\n5.9914645`} language="output"></CodeChunk>
            </div>
          </div>
        ),
      },
