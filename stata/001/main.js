      ...
      },
      {
        ...
        content: (
          <div>
            ...
            <CodeChunk code={`describe`} language="stata" />
            <CodeChunk code={`Contains data\nobs: 10 \nvars: 3 \nsize: 120 \n---------------------------------------------------------------------------------------------\nstorage display value\nvariable name type format label variable label\n---------------------------------------------------------------------------------------------\ncase  float %9.0g\nresponse  float %9.0g\nfreq  float %9.0g\n---------------------------------------------------------------------------------------------\nSorted by:\n Note: Dataset has changed since last saved.`} language="output" />
            <p>
      ...
      },
      {
        ...
        content: (
          <div>
            ...
            <CodeChunk code={`ta response case [fw=freq], freq`} language="stata" />
            <CodeChunk code={`. ta response case [fw=freq], freq\n\nAgr of | case\nOnset | f % | Total\n-----------+----------------------+----------\n70-79 | 9 6 | 15 \n60-69 | 18 12 | 30 \n50-59 | 42 28 | 70 \n40-49 | 51 34 | 85 \n30-39 | 30 20 | 50 \n-----------+----------------------+----------\nTotal | 150 100 | 250 `} language="output" />
          </div>
        ),
      },
      {
