        ...
        <>
          ...
          <div className="my-2">
            ...
            <CodeChunk
              ...
              lang="output"
            />
            <ZoomImage className="w-lg-50 w-sm-75 mx-auto" src={`${domain}/assets/images/anova01.png`} />
          </div>
        </>
      ),
    },
        ...
        <>
          <ol>
            ...
            <ol type="i">
              ...
              <ZoomImage className="w-lg-50 w-sm-75 mx-auto" src={`${domain}/assets/images/twoway-anova01.png`} />
              <li>只有A因子有效應：</li>
              <p>顯示在無論有沒有使用到B因子的情況下，若使用到A因子，則心率會從60bps增加到80bps。</p>
              <ZoomImage className="w-lg-50 w-sm-75 mx-auto" src={`${domain}/assets/images/twoway-anova02.png`} />
              <li>只有B因子有效應：</li>
              <p>顯示在無論有沒有使用到A因子的情況下，若沒有使用到B因子，則心率會一直停留在60bps，但若使用了B因子時，則⼼率增加到70bps。</p>
              <ZoomImage className="w-lg-50 w-sm-75 mx-auto" src={`${domain}/assets/images/twoway-anova03.png`} />
              ...
              <p>因此，A與B之間沒有交互影響。</p>
              <ZoomImage className="w-lg-50 w-sm-75 mx-auto" src={`${domain}/assets/images/twoway-anova04.png`} />
              <li>A因子和B因子之間存在交互作用，但主要效應僅在B因子上：</li>
              <p>這裡心率增加的15bps是A與B交互作用的效應。另外，我們也可以說A因子是沒有效應的，但⼀旦增加了B因⼦後，我們不但看到了B因子的效應，也看到了A和B合起來的效應。</p>
              <ZoomImage className="w-lg-50 w-sm-75 mx-auto" src={`${domain}/assets/images/twoway-anova05.png`} />
              <li>A和B都存在著主效應，並且交互作用的效應也存在。</li>
              <ZoomImage className="w-lg-50 w-sm-75 mx-auto" src={`${domain}/assets/images/twoway-anova06.png`} />
            </ol>
          </ol>
          <div className="my-2">
            ...
            <CodeChunk
              ...
              lang="output"
            />
            <ZoomImage className="w-lg-50 w-sm-75 mx-auto" src={`${domain}/assets/images/twoway-anova07.png`} />
          </div>
        </>
      ),
    },
