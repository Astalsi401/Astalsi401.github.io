          ...
          <div>
            <ol>
              ...
              <li>
                ...
                <ZoomImage class="mx-auto w-sm-75" src="https://astalsi401.github.io/assets/images/chi-square01.png"></ZoomImage>
                <ol type="i">
                  <li>是右偏的分配。</li>
                  <li>
                    最小檢定值
                  ...
                  <li>
                    ...
                    <ul>
                      <li>
                        ...
                        =5時，找出右邊分配的機率值
                        <CodeChunk code={`di chi2tail(2, 5)`} language="stata"></CodeChunk>
                        <CodeChunk code={`. di chi2tail(2, 5)\n.082085`} language="output"></CodeChunk>
                      </li>
                      <li>
                        ...
                        值<CodeChunk code={`di invchi2tail(2, .082085)`} language="stata"></CodeChunk>
                        <CodeChunk code={`. di invchi2tail(2, .082085)\n5`} language="output"></CodeChunk>
                      </li>
                    </ul>
                  </li>
                </ol>
            ...
            <div className="my-2">
              ...
              <CodeChunk code={`chitesti 12 14 5 9 10 \ 10 10 10 10 10 `} language="stata"></CodeChunk>
            ...
            <div className="my-2">
              ...
              <p>也能直接用這種方法</p>
              <CodeChunk code={`tabi 15 5 \\ 10 10, chi exp`} language="stata"></CodeChunk>
