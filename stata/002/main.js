    ...
    this.section = [
      {
        ...
        content: (
          <div>
            ...
            <CodeChunk code={`cd "C:\\Users\\misti\\Documents\\Stata\\unify"`} language="stata"></CodeChunk>
        ...
        content: (
          <div>
            ...
            <div className="my-2">
              ...
              <CodeChunk code={`outfile make price rep78 weight length using "1978 Automobile_part.csv", comma replace`} language="stata"></CodeChunk>
              <CodeChunk code={`. outfile make price rep78 weight length using "1978 Automobile_part.csv", comma replace\n(note: file 1978 Automobile_part.csv not found)`} language="output"></CodeChunk>
              <p>或直接全部匯出。</p>
              <CodeChunk code={`outfile using "1978 Automobile.csv", comma replace`} language="stata"></CodeChunk>
              <CodeChunk code={`. outfile using "1978 Automobile.csv", comma replace\n(note: file 1978 Automobile.csv not found)`} language="output"></CodeChunk>
              <p>
        ...
        content: (
          <div>
            ...
            <div className="my-2">
              ...
              <CodeChunk code={`cd data\nuse data1a, clear\nd /*簡單列出資料檔的資訊*/`} language="stata"></CodeChunk>
