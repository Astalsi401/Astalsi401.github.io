    ...
    this.section = [
        ...
        content: (
          <div>
            ...
            <div className="my-2">
              ...
              <CodeChunk code={`import exc using data2b.xlsx, sh("sheetname") cellra(A2) first clear`} language="stata" />
            </div>
            <div className="my-2">
              <div className="text-bold text-large">
      ...
      },
      {
        ...
        content: (
          <div>
            ...
            <p>查看資料中的變項。</p>
            <CodeChunk code={`sysuse auto, clear\ndes\ncd data`} language="stata" />
            <CodeChunk code={`. sysuse auto, clear\n(1978 Automobile Data)\n\n. des\n\nContains data from D:\\Tools\\Stata15\\ado\\base/a/auto.dta\n  obs:            74                          1978 Automobile Data\n vars:            12                          13 Apr 2016 17:45\n size:         3,182                          (_dta has notes)\n---------------------------------------------------------------------------------------------\n              storage   display    value\nvariable name   type    format     label      variable label\n---------------------------------------------------------------------------------------------\nmake            str18   %-18s                 Make and Model\nprice           int     %8.0gc                Price\nmpg             int     %8.0g                 Mileage (mpg)\nrep78           int     %8.0g                 Repair Record 1978\nheadroom        float   %6.1f                 Headroom (in.)\ntrunk           int     %8.0g                 Trunk space (cu. ft.)\nweight          int     %8.0gc                Weight (lbs.)\nlength          int     %8.0g                 Length (in.)\nturn            int     %8.0g                 Turn Circle (ft.)\ndisplacement    int     %8.0g                 Displacement (cu. in.)\ngear_ratio      float   %6.2f                 Gear Ratio\nforeign         byte    %8.0g      origin     Car type\n---------------------------------------------------------------------------------------------\nSorted by: foreign\n\n. cd data\nD:\\documents\\stata\\stata\\unify\\data`} language="output" />
            <div className="my-2">
              <div className="text-bold text-large">匯出Csv</div>
              <p>
                <code>outfile</code>匯出
              </p>
              <CodeChunk code={`outfile make price rep78 weight length using "1978 Automobile_part.csv", comma replace`} language="stata" />
              <CodeChunk code={`. outfile make price rep78 weight length using "1978 Automobile_part.csv", comma replace\n(note: file 1978 Automobile_part.csv not found)`} language="output" />
              <p>或直接全部匯出。</p>
              <CodeChunk code={`outfile using "1978 Automobile.csv", comma replace`} language="stata" />
              <CodeChunk code={`. outfile using "1978 Automobile.csv", comma replace\n(note: file 1978 Automobile.csv not found)`} language="output" />
              <p>
                <code>outsheet</code>匯出
              </p>
              <CodeChunk code={`outsheet using "1978 Automobile.csv", c n replace`} language="stata" />
            </div>
            <div className="my-2">
              <div className="text-bold text-large">匯出Xlsx</div>
              <CodeChunk code={`export exc using 1978 Automobile.xlsx, sh("sheetname") first(var) sheetrep`} language="stata" />
            </div>
          </div>
        ),
      },
      {
        ...
        content: (
          <div>
            <p>在STATA中開啟圖表</p>
            <CodeChunk code={`graph use "1978auto.gph`} language="stata" />
        ...
        content: (
          <div>
            ...
            <div className="my-2">
              ...
              <CodeChunk code={`cd data\nuse data1a, clear\nd /*簡單列出資料檔的資訊*/`} language="stata" />
              <CodeChunk code={`. cd data\nC:\\Users\\misti\\Documents\\Stata\\unify\\data\n\n. use data1a, clear\n\n. d /*簡單列出資料檔的資訊*/\n\nContains data from data1a.dta\n  obs:            30                          \n vars:             3                          26 Nov 2020 19:06\n size:           360                          \n---------------------------------------------------------------------------------------------------------------\n              storage   display    value\nvariable name   type    format     label      variable label\n---------------------------------------------------------------------------------------------------------------\nid              float   %9.0g                 \nmale            float   %9.0g                 \nscore1          float   %9.0g                 \n---------------------------------------------------------------------------------------------------------------\nSorted by: id`} language="output" />
