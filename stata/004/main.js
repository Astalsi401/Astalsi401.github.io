        ...
        content: (
          <div>
            ...
            <div className="my-2">
              ...
              <CodeChunk code={`table egpnow, c(mean edyear sd edyear n edyear) format(%9.2f) row`} language="stata" />
      ...
      },
      {
        ...
        content: (
          <div>
            ...
            <CodeChunk code={`local varType: type var  /*獲取變項類型*/if substr("\`varType'", 1, 3) == "str" {  如果變項類型為文字(str) do some stata code...} else {  some stata code...}`} language="stata" />
          </div>
        ),
      },
    ];
