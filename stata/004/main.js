          ...
          <div>
            ...
            <ul>
              ...
              <li>
                ...
                <CodeChunk code={`d v11   /*d: describe的縮寫，也可以寫成des，檢視該份資料的屬性*/\nta v11  /*ta: tabulate的縮寫，以表格呈現，也能寫為tab*/`} language="stata"></CodeChunk>
                <CodeChunk
      ...
      },
      {
        ...
        content: (
          <div>
            ...
            <CodeChunk code={`local varType: type var  /*獲取變項類型*/if substr("\`varType'", 1, 3) == "str" {  如果變項類型為文字(str) do some stata code...} else {  some stata code...}`} language="stata"></CodeChunk>
          </div>
        ),
      },
    ];
