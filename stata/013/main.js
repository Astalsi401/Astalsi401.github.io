  ...
  constructor(props) {
    ...
    this.section = [
                ...
                <ol type="i">
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      <ZoomImage class="w-lg-50 w-sm-75 mx-auto" src="https://astalsi401.github.io/assets/images/reg01.png"></ZoomImage>
                    </li>
                  </ul>
                  <li>
                    線性關係
                      ...
                      <li>
                        ...
                        <ul>
                          ...
                          <CodeChunk
                            ...
                            language="output"
                          ></CodeChunk>
                          <ZoomImage class="w-lg-50 w-sm-75 mx-auto" src="https://astalsi401.github.io/assets/images/reg02.png"></ZoomImage>
                        </ul>
                      </li>
                    </ol>
                  </li>
      ...
      },
      {
        ...
        content: (
          <div>
            <CodeChunk code={`clear\ninput x y\n0  12\n3  13\n1  15\n0  19\n6  26\n5  27\n3  29\n4  31\n10 40\n8  48\nend\n\nlab var x "先前犯罪紀錄"\nlab var y "刑期(⽉)"\n\nreg y x`} language="stata"></CodeChunk>
            ...
            <div className="my-2">
              ...
              <ol>
                ...
                <li>
                  ...
                  <CodeChunk code={`cap drop yhat\npredict yhat, xb\nlist x y yhat, nolab clean noobs\ntwoway (sca y x, mc(black)) ///\n       (sca yhat x, c(l) mc(red)), ///\n       ylab(0(5)50, angle(0)) ///\n       ytitle("刑期（月）") ///\n       legend(label(1 "x的原始觀察點") label(2 "y的預測點"))\ngraph export reg03.png, replace`} language="stata"></CodeChunk>
                  <CodeChunk code={`. cap drop yhat\n\n. predict yhat, xb\n\n. list x y yhat, nolab clean noobs\n\n     x    y   yhat  \n     0   12     14  \n     3   13     23  \n     1   15     17  \n     0   19     14  \n     6   26     32  \n     5   27     29  \n     3   29     23  \n     4   31     26  \n    10   40     44  \n     8   48     38  \n\n. twoway (sca y x, mc(black)) ///\n>            (sca yhat x, c(l) mc(red)), ///\n>        ylab(0(5)50, angle(0)) ///\n>        ytitle("刑期（月）") ///\n>        legend(label(1 "x的原始觀察點") label(2 "y的預測點"))\n\n. graph export reg03.png, replace\n(file reg03.png written in PNG format)`} language="output"></CodeChunk>
                  <ZoomImage class="w-lg-50 w-sm-75 mx-auto" src="https://astalsi401.github.io/assets/images/reg03.png"></ZoomImage>
                </li>
                <li>得到的迴歸係數可用來估算當x在某一狀況時，Y可能有的結果。</li>
                <li>
                  其次，我們可以從迴歸係數故估算殘差值，從而了解模型的擬合程度（The goodness of ﬁt）。此部分可以用來了解模型的優劣。
                  <CodeChunk code={`predict cancha, resid\nlist x y yhat cancha, nolab clean noobs`} language="stata"></CodeChunk>
                  <CodeChunk code={`. predict cancha, resid\n\n. list x y yhat cancha, nolab clean noobs\n\n     x    y   yhat   cancha  \n     0   12     14       -2  \n     3   13     23      -10  \n     1   15     17       -2  \n     0   19     14        5  \n     6   26     32       -6  \n     5   27     29       -2  \n     3   29     23        6  \n     4   31     26        5  \n    10   40     44       -4  \n     8   48     38       10`} language="output"></CodeChunk>
                </li>
                <li>
                  一個好的迴歸模型其殘差與X變項之間的關係為0，例如：
                  <CodeChunk code={`corr x cancha`} language="stata"></CodeChunk>
                  <CodeChunk code={`. corr x cancha\n(obs=10)\n\n             |        x   cancha\n-------------+------------------\n           x |   1.0000\n      cancha |   0.0000   1.0000`} language="output"></CodeChunk>
                </li>
                <li>
                  殘差與y的預測值之間的相關係數也應該是0，例如：
                  <CodeChunk code={`corr yhat cancha`} language="stata"></CodeChunk>
        ...
        content: (
          <div>
            <div className="my-2">
              ...
              <p>5x+2y+8z=46</p>
              <p>輸入資料：</p>
              <CodeChunk code={`clear matrix\nmat a = [6,3,7\\1,4,0\\5,2,8]  /*mat: matrix的縮寫，輸入矩陣a*/\nmat list a    /*列出矩陣a*/\nmat b = [51\\26\\46]\nmat list b`} language="stata"></CodeChunk>
              <CodeChunk code={`. clear matrix\n\n. mat a = [6,3,7\\1,4,0\\5,2,8]  /*mat: matrix的縮寫，輸入矩陣a*/\n\n. mat list a    /*列出矩陣a*/\n\na[3,3]\n    c1  c2  c3\nr1   6   3   7\nr2   1   4   0\nr3   5   2   8\n\n. mat b = [51\\26\\46]\n\n. mat list b\n\nb[3,1]\n    c1\nr1  51\nr2  26\nr3  46`} language="output"></CodeChunk>
              <p>
                求解公式：r =(a<sup>-1</sup>)*b
              </p>
              <CodeChunk code={`mat inva=inv(a)\nmat r=inva*b\nmat list r`} language="stata"></CodeChunk>
              <CodeChunk code={`. mat inva=inv(a)\n\n. mat r=inva*b\n\n. mat list r\n\nr[3,1]\n    c1\nc1   2\nc2   6\nc3   3`} language="output"></CodeChunk>
              <p>Ans：x=2, y=6, z=3</p>
            </div>
            <div className="my-2">
