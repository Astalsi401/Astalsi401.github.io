  ...
  constructor(props) {
    ...
    this.section = [
      ...
      },
      {
        ...
        content: (
          <div>
            <CodeChunk code={`graph pie, over(ur0) plabel(_all percent) title(Class Interval) legend(cols(4))\ngraph export "pie01.png", replace`} language="stata"></CodeChunk>
            <CodeChunk code={`. graph pie, over(ur0) plabel(_all percent) title(Class Interval) legend(cols(4))\n. graph export "pie01.png", replace\n(file pie01.png written in PNG format)`} language="output"></CodeChunk>
            <ZoomImage src="https://astalsi401.github.io/assets/images/pie01.png"></ZoomImage>
          </div>
        ),
      },
      {
        ...
        content: (
          <div>
            <CodeChunk code={`clear\ninput year crate\n1987 612.5\n1988 640.6\n1989 666.9\n1990 729.6\n1991 758.2\n1992 757.7\n1993 747.1\n1994 713.6\n1995 684.5\n1996 636.6\n1997 611.0\n1998 567.6\n1999 523.0\n2000 506.5\n2001 504.5\n2002 494.4\n2003 475.8\n2004 463.2\n2005 469.0\n2006 479.3\n2007 471.8\n2008 458.6\n2009 431.9\n2010 403.6\nend\nlab var year "Year"\ntwoway (scatter crate year, c(l)), /// /*c(l) 用線將點連起來*/\n   ylabel(, angle(0))              ///\n   ytitle("Violent Crime Rate")\ngraph export "sca01.png", replace`} language="stata"></CodeChunk>
            <CodeChunk code={`. clear\n. input year crate\n      year crate\n   1. 1987 612.5\n   2. 1988 640.6\n   3. 1989 666.9\n   4. 1990 729.6\n   5. 1991 758.2\n   6. 1992 757.7\n   7. 1993 747.1\n   8. 1994 713.6\n   9. 1995 684.5\n  10. 1996 636.6\n  11. 1997 611.0\n  12. 1998 567.6\n  13. 1999 523.0\n  14. 2000 506.5\n  15. 2001 504.5\n  16. 2002 494.4\n  17. 2003 475.8\n  18. 2004 463.2\n  19. 2005 469.0\n  20. 2006 479.3\n  21. 2007 471.8\n  22. 2008 458.6\n  23. 2009 431.9\n  24. 2010 403.6\n  25. end\n. lab var year "Year"\n. twoway (scatter crate year, c(l)), /// /*c(l) 用線將點連起來*/\n>    ylabel(, angle(0))              ///\n>    ytitle("Violent Crime Rate")\n.  graph export "sca01.png", replace\n(file sca01.png written in PNG format)`} language="output"></CodeChunk>
            <ZoomImage src="https://astalsi401.github.io/assets/images/sca01.png"></ZoomImage>
          </div>
        ),
      },
      {
        ...
        content: (
          <div>
            <CodeChunk code={`clear\ninput gender x\n0 5\n0 2\n0 7\n0 9\n0 3\n0 4\n0 3\n0 1\n0 3\n0 8\n1 3\n1 5\n1 7\n1 4\n1 5\n1 6\n1 7\n1 6\n1 5\n1 4\nend\nlab var gender "gender"\nlab def gender 0 "Male" 1 "Female", modify\nlab val gender gender\ngraph box x, over (gender) ytitle("抽菸次數/週") b1title("性別") \n                          /*b1title: b1=下排第一層*/\ngraph export "box01.png", replace`} language="stata"></CodeChunk>
            <CodeChunk code={`. clear\n. input gender x\n    gender x\n 1. 0 5\n 2. 0 2\n 3. 0 7\n 4. 0 9\n 5. 0 3\n 6. 0 4\n 7. 0 3\n 8. 0 1\n 9. 0 3\n10. 0 8\n11. 1 3\n12. 1 5\n13. 1 7\n14. 1 4\n15. 1 5\n16. 1 6\n17. 1 7\n18. 1 6\n19. 1 5\n20. 1 4\n21. end\n. lab var gender "gender"\n. lab def gender 0 "Male" 1 "Female", modify\n. lab val gender gender\n. graph box x, over (gender) ytitle("抽菸次數/週") b1title("性別") \n.                           /*b1title: b1=下排第一層*/\n. graph export "box01.png", replace\n(file box01.png written in PNG format)`} language="output"></CodeChunk>
            <ZoomImage src="https://astalsi401.github.io/assets/images/box01.png"></ZoomImage>
          </div>
        ),
      },
      {
