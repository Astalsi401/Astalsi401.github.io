    ...
    },
    {
      ...
      content: (
        <>
          ...
          <ZoomImage className="w-lg-50 w-sm-75 mx-auto" src={`${domain}/assets/images/line01.png`} />
        </>
      ),
    },
    {
      ...
      content: (
        <>
          ...
          <ZoomImage className="w-lg-50 w-sm-75 mx-auto" src={`${domain}/assets/images/bar01.png`} />
          <ul>
            <li>
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <ZoomImage className="w-lg-50 w-sm-75 mx-auto" src={`${domain}/assets/images/pie01.png`} />
        </>
      ),
    },
    {
      ...
      content: (
        <>
          ...
          <ZoomImage className="w-lg-50 w-sm-75 mx-auto" src={`${domain}/assets/images/sca01.png`} />
        </>
      ),
    },
    {
      ...
      content: (
        <>
          ...
          <ZoomImage className="w-lg-50 w-sm-75 mx-auto" src={`${domain}/assets/images/box01.png`} />
        </>
      ),
    },
    {
