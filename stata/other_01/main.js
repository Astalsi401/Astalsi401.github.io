    ...
    this.section = [
      {
        ...
        content: (
          <>
            ...
            <ol>
              ...
              <li>
                ...
                <ol type="i">
                  <li>
                    開啟預設設定檔
                    <ZoomImage className="w-lg-50 w-sm-75 mx-auto" src="https://astalsi401.github.io/assets/images/step5-1.png" />
                  </li>
                  <li>
                    開啟自訂設定檔
                    <ZoomImage className="w-lg-50 w-sm-75 mx-auto" src="https://astalsi401.github.io/assets/images/step5-2.png" />
                  </li>
                  <li>將預設檔全選並複製到自訂檔</li>
                  <li>
                  ...
                  <li>
                    ...
                    <ZoomImage className="w-lg-50 w-sm-75 mx-auto" src="https://astalsi401.github.io/assets/images/step5-5.png" />
                  </li>
                </ol>
              </li>
              ...
              <li>
                ...
                <ZoomImage className="w-lg-50 w-sm-75 mx-auto" src="https://astalsi401.github.io/assets/images/step7.png" />
              </li>
              <li>
                此時引號會消失，代表已成功
                <ZoomImage className="w-lg-50 w-sm-75 mx-auto" src="https://astalsi401.github.io/assets/images/step8.png" />
              </li>
            ...
            <ZoomImage className="w-lg-50 w-sm-75 mx-auto" src="https://astalsi401.github.io/assets/images/step9-1.png" />
            <ZoomImage className="w-lg-50 w-sm-75 mx-auto" src="https://astalsi401.github.io/assets/images/step9-2.png" />
          </>
        ),
      },
      {
