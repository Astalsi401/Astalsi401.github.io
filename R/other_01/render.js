    ...
    content={
      <div>
        <ul>
          <li>
            載入套件包
            <CodeChunk code={`library(networkD3)\nlibrary(magrittr)\nlibrary(dplyr)`} language="r"></CodeChunk>
            <CodeChunk code={`## \n## 載入套件：'dplyr'`} language="output"></CodeChunk>
            <CodeChunk code={`## 下列物件被遮斷自 'package:stats':\n## \n##     filter, lag`} language="output"></CodeChunk>
            <CodeChunk code={`## 下列物件被遮斷自 'package:base':\n## \n##     intersect, setdiff, setequal, union`} language="output"></CodeChunk>
          </li>
          <li>
            輸入資料
            <p>
