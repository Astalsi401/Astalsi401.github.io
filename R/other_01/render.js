    ...
    content={
      <div>
        <ul>
          <li>
            載入套件包
            <CodeChunk code={`library(networkD3)\nlibrary(magrittr)\nlibrary(dplyr)`} lang="r" />
            <CodeChunk code={`## \n## 載入套件：'dplyr'`} lang="output" />
            <CodeChunk code={`## 下列物件被遮斷自 'package:stats':\n## \n##     filter, lag`} lang="output" />
            <CodeChunk code={`## 下列物件被遮斷自 'package:base':\n## \n##     intersect, setdiff, setequal, union`} lang="output" />
          </li>
          <li>
            輸入資料
            <p>
