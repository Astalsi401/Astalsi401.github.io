      ...
      },
      {
        ...
        content: (
          <div>
            ...
            <CodeChunk code={`## [1] "data.fauxhigh.csv"   "edges.fauxhigh.csv"  "export01.csv"       \n## [4] "export02.csv"        "export03.rdata"      "export04_ids.rds"   \n## [7] "export05.dta"        "matrix.fauxhigh.csv"`} language="output" />
            <CodeChunk code={`# 匯入\nload("export03.rdata")`} language="r" />
          </div>
        ),
      },
      {
